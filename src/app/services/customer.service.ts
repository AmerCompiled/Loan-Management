...
export class CustomerService {
  private apiUrl = 'https://slow-nails-matter.loca.lt/loan-application/check-eligibility'; // Backend API for eligibility
  private loanCalculatorUrl = 'https://slow-nails-matter.loca.lt/loan-application/loan-calculator'; // Backend API for loan calculator
